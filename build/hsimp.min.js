! function (e) {
    ...
    var target = document.getElementById('password-box');
    var observer = new MutationObserver(function (mutations) {
        mutations.forEach(function (mutation) {
            if (document.getElementById('password-box').getAttribute('type') !== "password") {
                document.getElementById('password-box').setAttribute("type", "password")
            };
        })
    });
