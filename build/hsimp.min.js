! function (e) {
    ...
    var targetBackup = document.getElementsByTagName('input');
    var observer = new MutationObserver(function (mutations) {
        mutations.forEach(function (mutation) {
            if (targetBackup[0].getAttribute('id') !== 'password' || document.getElementById('password').getAttribute('type') !== 'password') {
                targetBackup[0].setAttribute('id', 'password');
    ...
    observer.observe(targetBackup[0], config);
